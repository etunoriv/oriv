...
/**
 * ProductSurface — Oriv app frame. A single focused knowledge record showing
 * a real engineering decision: the decision itself, the reasoning, the cited
 * sources, who made it, and where it has been reused. One artifact, deep —
 * not a tour of product pillars.
 */
                ...
                <div className="space-y-3">
                  <div className="overflow-hidden rounded-lg border border-white/[0.06]">
                    ...
                    <p className="px-3 py-2.5 text-[11.5px] leading-[1.5] text-white/85">
                      Slew rate locked at 1.0 V/µs across the full operating
                      range.
                    </p>
                  </div>
                  <div className="overflow-hidden rounded-lg border border-white/[0.06]">
                    ...
                    <p className="px-3 py-2.5 text-[11.5px] leading-[1.55] text-white/75">
                      Spec rev C requires 1.0 V/µs across &minus;40 to
                      +125&deg;C. Vendor typical (1.2 V/µs at 25&deg;C) drops
                      to 0.85 V/µs at Tj &gt; 100&deg;C in bench testing. The
                      floor was selected to hold through the operating
                      envelope.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="overflow-hidden rounded-lg border border-white/[0.06]">
                    ...
                    <ul className="space-y-1 px-3 py-2.5 font-mono text-[10.5px] leading-[1.5] text-white/65">
                      <li>&bull; Spec rev C &middot; p.3 &middot; tbl 2.4</li>
